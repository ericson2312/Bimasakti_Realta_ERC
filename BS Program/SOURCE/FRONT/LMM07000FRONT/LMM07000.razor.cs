...
namespace LMM07000FRONT
{
    public partial class LMM07000 : R_Page
    {
        ...
        private async Task ChargesDiscount_R_Before_Open_Popup_ActivateInactive(R_BeforeOpenPopupEventArgs eventArgs)
        {
            var loData = (LMM07000DTO)_LMM07000ViewModel.R_GetCurrentData();
            ...
            try
            {
                ...
                {
                    await _LMM07000ViewModel.ActiveInactiveProcessAsync(loData);
                    await _ChargesDiscount_conductorRef.R_SetCurrentData(loData);
                    return;
                }
        ...
        private async Task ChargesDiscount_R_After_Open_Popup_ActivateInactive(R_AfterOpenPopupEventArgs eventArgs)
        {
