...
namespace LMM01500FRONT
{
    public partial class LMM01500 : R_Page
    {
        ...
        private void General_AfterSave(R_AfterSaveEventArgs eventArgs)
        {
            ...
            _Genereal_gridRef.CurrentSelectedData.CINVGRP_CODE_NAME = $"{_Genereal_gridRef.CurrentSelectedData.CINVGRP_CODE} - {_Genereal_gridRef.CurrentSelectedData.CINVGRP_NAME}";
        }
