...
namespace GSM09200MODEL.ViewModel
{
    public class GSM09200ViewModel : R_ViewModel<GSM09200DetailDTO>
    {
        ...
        public List<GSM09200DTO> loExpenditureCategoryList = new List<GSM09200DTO>();
        ...
        public async Task GetExpenditureCategoryListStreamAsync()
        {
            ...
            try
            {
                ...
                loExpenditureCategoryList = new List<GSM09200DTO>(loRtn.Data);
                loExpenditureCategoryList.ForEach(x =>
                {
