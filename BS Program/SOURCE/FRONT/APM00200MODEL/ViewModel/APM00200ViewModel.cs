    ...
    public class APM00200ViewModel : R_ViewModel<APM00200DetailDTO>
    {
        ...
        public void ExpenditureValidation(APM00200DetailDTO poParam)
        {
            ...
            try
            {
                ...
                llCancel = string.IsNullOrWhiteSpace(poParam.CUNIT);
                if (llCancel)
                {
                    loEx.Add(R_FrontUtility.R_GetError(
                        typeof(Resources_Dummy_Class),
                ...
                llCancel = string.IsNullOrWhiteSpace(poParam.CWITHHOLDING_TAX_ID) && poParam.LWITHHOLDING_TAX;
                if (llCancel)
                {
                    loEx.Add(R_FrontUtility.R_GetError(
                        typeof(Resources_Dummy_Class),
                ...
                llCancel = string.IsNullOrWhiteSpace(poParam.CWITHHOLDING_TAX_TYPE) && poParam.LWITHHOLDING_TAX;
                if (llCancel)
                {
                    loEx.Add(R_FrontUtility.R_GetError(
                        typeof(Resources_Dummy_Class),
