...
namespace GSM09300MODEL.ViewModel
{
    public class GSM09300ViewModel : R_ViewModel<GSM09300DetailDTO>
    {
        ...
        public List<GSM09300DTO> loSupplierCategoryList = new List<GSM09300DTO>();
        ...
        public async Task GetSupplierCategoryListStreamAsync()
        {
            ...
            try
            {
                ...
                loSupplierCategoryList = new List<GSM09300DTO>(loRtn.Data);
                loSupplierCategoryList.ForEach(x =>
                {
