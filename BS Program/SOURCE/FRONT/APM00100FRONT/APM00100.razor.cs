...
namespace APM00100FRONT
{
    public partial class APM00100 : R_Page
    {
        ...
        [Inject] private R_ILocalizer<APM00100FrontResources.Resources_Dummy_Class> _localizer { get; set; }
        ...
        protected override async Task R_Init_From_Master(object poParameter)
        {
            ...
            try
            {
                ...
                if (loAPSystemParamViewModel.loGetSystemParam.IRESULT == 0)
                {
                    ...
                    {
                        await R_MessageBox.Show("", _localizer["M001"], R_eMessageBoxButtonType.OK);
                    }
                }
        ...
        private void Grid_BeforeEditAPSystemParam(R_BeforeEditEventArgs eventArgs)
        {
            IsAllowEditGLLink = loAPSystemParamViewModel.loAPSystemParam.LALLOW_EDIT_GLLINK;
        }

        private void Grid_BeforeCancelAPSystemParam(R_BeforeCancelEventArgs eventArgs)
        {
            IsAllowEditGLLink = false;
        }

        private void Grid_AfterSaveAPSystemParam(R_AfterSaveEventArgs eventArgs)
        {
            IsAllowEditGLLink = false;
        }
