...
{
    public class GLT00500ViewModel : R_ViewModel<GLT00500DetailDTO>, R_IProcessProgressStatus
    {
        ...
        public GLT00500HeaderDTO loHeader = null;

        public GLT00500HeaderDTO loHeaderDisplay = new GLT00500HeaderDTO();

        public GLT00500DetailDTO loDetail = null;

        public List<GLT00500DetailDTO> loDetailList = null;

        public ObservableCollection<GLT00500DetailDTO> loDetailDisplayList = new ObservableCollection<GLT00500DetailDTO>();

        public GLT00500DetailResultDTO loRtn = null;
        ...
        public ImportAdjustmentJournalSaveResultDTO loErrorRtn = null;
        ...
        public async Task SaveUploadFile()
        {
            ...
            ImportAdjustmentJournalParameterDTO Bigobject;
            ...
            try
            {
                ...
                ImportAdjustmentJournalSaveParameterDTO loParam = new ImportAdjustmentJournalSaveParameterDTO()
                {
                    HeaderData = loHeaderDisplay,
                    DetailData = new List<GLT00500DetailDTO>(loDetailDisplayList)
                };
                ...
                loBatchValidatePar.ClassName = "GLT00500BACK.GLT00500Cls";
                loBatchValidatePar.BigObject = loParam;

                PROCESS_TYPE = SAVE_PROCESS;
                lcKeyGuid = await loCls.R_BatchProcess<ImportAdjustmentJournalSaveParameterDTO>(loBatchValidatePar, 17);
        ...
        public async Task ImportAdjustmentJournalStreamAsync()
        {
            ...
            try
            {
                ...
                List<GLT00500DetailDTO> loDetailTemp = new List<GLT00500DetailDTO>();
                ...
                ImportAdjustmentJournalParameterDTO loParam = new ImportAdjustmentJournalParameterDTO()
                {
                    HeaderData = loHeader,
                ...
                loBatchValidatePar.USER_ID = LoginUserId;
                loBatchValidatePar.UserParameters = loUserParam;
                loBatchValidatePar.ClassName = "GLT00500BACK.GLT00500ValidateUploadCls";
                loBatchValidatePar.BigObject = loParam;

                PROCESS_TYPE = CALCULATE_PROCESS;
                string lcKeyGuid = await loCls.R_BatchProcess<ImportAdjustmentJournalParameterDTO>(loBatchValidatePar, 2);
        ...
        public void ImportAdjustmentJournalValidation()
        {
            bool llCancel = false;
        ...
        private async Task GetSuccess(string pcKeyGuid)
        {
            try
            {
                R_FrontContext.R_SetStreamingContext(ContextConstant.UPLOAD_GLT00500_ERROR_GUID_STREAMING_CONTEXT, pcKeyGuid);

                loSuccessRtn = await loModel.GetSuccessProcessListStreamingAsync();

                List<GLT00500DetailDTO> loTemp = new List<GLT00500DetailDTO>();
                loTemp = loSuccessRtn.Data.Select((x, i) => new GLT00500DetailDTO()
                {
                    SEQ_NO = i + 1,
                ...
                loDetailDisplayList = new ObservableCollection<GLT00500DetailDTO>(loTemp);
...
/*
        private async Task GetErrorCountAsync(string pcKeyGuid)
        {
            try
            {
                R_FrontContext.R_SetContext(ContextConstant.UPLOAD_GLT00500_ERROR_COUNT_GUID_CONTEXT, pcKeyGuid);
...
*/
        ...
        public async Task<TemplateImportAdjustmentJournalDTO> DownloadTemplateImportAdjustmentJournalAsync()
        {
            ...
            try
            {
                loResult = await loModel.DownloadTemplateImportAdjustmentJournalAsync();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
