...
namespace LMM03500FRONT
{
    public partial class LMM03502 : R_Page, R_ITabPage
    {
        ...
        private R_CheckBox _overwriteRef;
        ...
        private async Task ProfileAndTaxInfo_Display(R_DisplayEventArgs eventArgs)
        {
        ...
        private async Task DisplayBilling(R_DisplayEventArgs eventArgs)
        {
            if (eventArgs.ConductorMode == R_eConductorMode.Edit)
            {
                await _overwriteRef.FocusAsync();
            }
        }
        ...
        private async Task OnActiveTabIndexChanged(R_TabStripTab eventArgs)
        {
            ...
            if (_conductorProfileTaxRef.R_ConductorMode == R_eConductorMode.Normal)
            {
                if (string.IsNullOrWhiteSpace(loTenantProfileViewModel.Data.TaxInfo.CID_EXPIRED_DATE) == false)
                {
                    loTenantProfileViewModel.Data.TaxInfo.DID_EXPIRED_DATE = DateTime.ParseExact(loTenantProfileViewModel.Data.TaxInfo.CID_EXPIRED_DATE, "yyyyMMdd", null);
                }
            }
        ...
        */
        ...
        private void AfterOpenCityLookUp(R_AfterOpenLookupEventArgs eventArgs)
        {
            ...
            loTenantProfileViewModel.Data.Profile.CSTATE_CODE = loTempResult.CCODE_PROVINCE;
            loTenantProfileViewModel.Data.Profile.CSTATE_NAME = loTempResult.CNAME_PROVINCE;
            loTenantProfileViewModel.Data.Profile.CCOUNTRY_CODE = loTempResult.CCODE_COUNTRY;
            loTenantProfileViewModel.Data.Profile.CCOUNTRY_NAME = loTempResult.CNAME_COUNTRY;
            //loTenantProfileViewModel.Data.Profile.CJRNGRP_NAME = loTempResult.CJRNGRP_NAME;
        }
