...
namespace GSM09000FRONT
{
    ...
    {
        [Inject] private R_ILocalizer<GSM09000FrontResources.Resources_Dummy_Class> _localizer { get; set; }

        private GSM09000ViewModel loTenantCategoryViewModel = new();

        private R_Conductor _conductorTenantCategoryRef;

        private R_TreeView<GSM09000DTO> _treeTenantCategoryRef;
        ...
        private R_TextBox _tenantIdRef;

        private R_TextBox _tenantNameRef;
        ...
        private async Task PropertyDropdown_ValueChanged(string poParam)
        {
            ...
            try
            {
                ...
                await _treeTenantCategoryRef.R_RefreshTree(null);
...
/*
            ...
            {
                await _tenantNameRef.FocusAsync();
            }
        }

        private async Task Tree_TenantCategory_R_ServiceGetListRecord(R_ServiceGetListRecordEventArgs eventArgs)
        {
            R_Exception loEx = new R_Exception();
        ...
        private void Tree_R_RefreshTreeViewState(R_RefreshTreeViewStateEventArgs eventArgs)
        {
            ...
            try
            {
                List<GSM09000DTO> loTreeList = (List<GSM09000DTO>)eventArgs.TreeViewList;
...
*/
        ...
        private void Grid_TenantCategory_ConvertToGridEntity(R_ConvertToGridEntityEventArgs eventArgs)
        {
            GSM09000DetailDTO loConductorData = (GSM09000DetailDTO)eventArgs.Data;
            eventArgs.GridData = new GSM09000DTO
            {
