...
namespace LMM01000COMMON.Models
{
    ...
    {
        public static LMM01020ResultPrintDTO DefaultData()
        {
            ...
            LMM01020DTO loHeaderTempData = new LMM01020DTO
            {
                CCOMPANY_ID = "ABC123",
                ...
                CRATE_WG_LIST = new List<LMM01021DTO>()
            };

            // Create some detail data (LMM01021DTO) using a loop
            List<LMM01021DTO> loDetailTempData = new List<LMM01021DTO>();

            for (int i = 1; i <= 5; i++)
            {
                // Create a new LMM01021DTO object for each iteration of the loop
                LMM01021DTO detailItem = new LMM01021DTO
                {
                    CCOMPANY_ID = "ABC123",
                    CPROPERTY_ID = "PROP456",
                    CCHARGES_TYPE = "Electricity",
        ...
        public static LMM01020ResultWithBaseHeaderPrintDTO DefaultDataWithHeader()
        {
