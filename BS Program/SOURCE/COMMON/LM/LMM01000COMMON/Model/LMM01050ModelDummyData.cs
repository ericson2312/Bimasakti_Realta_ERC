...
namespace LMM01000COMMON.Models
{
    ...
    {
        public static LMM01050ResultPrintDTO DefaultData()
        {
            ...
            LMM01050DTO loHeaderTempData = new LMM01050DTO
            {
                CCOMPANY_ID = "ABC123",
            ...
            var loDetailData1 = new List<LMM01051DTO>();

            for (int i = 1; i <= 3; i++)
            {
                loDetailData1.Add(new LMM01051DTO
                {
                    CCOMPANY_ID = "ABC123",
                    CPROPERTY_ID = "PROP456",
                    CCHARGES_TYPE = "Electricity",
                    CCHARGES_ID = $"CHARGEWD00{i}",
                    CDAY_TYPE = "WD",
                    CUSER_ID = "USER001",
                    ILEVEL = i,
                    CLEVEL_DESC = $"Level {i}",
            ...
            var loDetailData2 = new List<LMM01051DTO>();

            for (int i = 1; i <= 2; i++)
            {
                loDetailData2.Add(new LMM01051DTO
                {
                    CCOMPANY_ID = "ABC123",
                    CPROPERTY_ID = "PROP456",
                    CCHARGES_TYPE = "Electricity",
                    CCHARGES_ID = $"CHARGEWK00{i}",
                    CDAY_TYPE = "WK",
                    CUSER_ID = "USER001",
                    ILEVEL = i + 3,
                    CLEVEL_DESC = $"Level {i}",
        ...
        public static LMM01050ResultWithBaseHeaderPrintDTO DefaultDataWithHeader()
        {
