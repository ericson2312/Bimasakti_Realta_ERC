...
namespace LMM01000COMMON.Models
{
    ...
    {
        public static LMM01010ResultPrintDTO DefaultData()
        {
            ...
            LMM01010DTO loHeaderTempData = new LMM01010DTO
            {
                CCOMPANY_ID = "ABC123",
                ...
                NKVA_RANGE = 8.0m,
                CRATE_EC_LIST = new List<LMM01011DTO>()
            };

            List<LMM01011DTO> loDetailTempData = new List<LMM01011DTO>();
            for (int i = 1; i <= 5; i++)
            {
                // Create a new LMM01011DTO object for each iteration of the loop
                LMM01011DTO detailItem = new LMM01011DTO
                {
                    CCOMPANY_ID = "ABC123",
                    CPROPERTY_ID = "PROP456",
                    CCHARGES_TYPE = "Electricity",
                    ...
                    CUSER_ID = "USER001",
                    IUP_TO_USAGE = 100 * i,
                    CUSAGE_DESC = $"Usage up to {100 * i} kWh",
        ...
        public static LMM01010ResultWithBaseHeaderPrintDTO DefaultDataWithHeader()
        {
