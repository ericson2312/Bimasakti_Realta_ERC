...
{
    public class APT00131Cls : R_BusinessObject<APT00131ParameterDTO>
    {
        ...
        public List<APT00131DTO> GetAdditionalList(GetAdditionalListParameterDTO poParameter)
        {
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<APT00131DTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override void R_Deleting(APT00131ParameterDTO poEntity)
        {
            R_Exception loException = new R_Exception();
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
        ...
        protected override APT00131ParameterDTO R_Display(APT00131ParameterDTO poEntity)
        {
            R_Exception loException = new R_Exception();
            APT00131DTO loResult = null;
            APT00131ParameterDTO loRtn = new APT00131ParameterDTO();
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
            DbCommand loCmd = null;
            string lcQuery;
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<APT00131DTO>(loDataTable).FirstOrDefault();
                loRtn.Data = loResult;
            }
            catch (Exception ex)
            {
        ...
        protected override void R_Saving(APT00131ParameterDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            R_Exception loException = new R_Exception();
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@CTRANS_CODE", DbType.String, 50, "131010");
                ...
                try
                {
                    ...
                    APT00131SaveResultDTO loResult = R_Utility.R_ConvertTo<APT00131SaveResultDTO>(loDataTable).FirstOrDefault();
