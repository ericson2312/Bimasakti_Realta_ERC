...
namespace GLT00500BACK
{
    public class GLT00500Cls : R_IBatchProcess
    {
        ...
        public List<GetImportAdjustmentJournalResult> GetSuccessProcess(string pcCompanyId, string pcUserId, string pcKeyGuid)
        {
            ...
            string lcQuery;
            List<GetImportAdjustmentJournalResult> loResult = null;
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<GetImportAdjustmentJournalResult>(loDataTableResult).ToList();
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        public ImportAdjustmentJournalSaveResultDTO GetErrorCount(string pcCompanyId, string pcUserId, string pcKeyGuid)
        {
            R_Exception loException = new R_Exception();
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<ImportAdjustmentJournalSaveResultDTO>(loDataTableResult).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        public List<ImportAdjustmentJournalErrorDTO> GetImportAdjustmentJournalErrorList(ImportAdjustmentJournalErrorParameterDTO poEntity)
        {
            R_Exception loException = new R_Exception();
            List<ImportAdjustmentJournalErrorDTO> loResult = null;
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
            DbCommand loCmd = null;
            string lcQuery;
            ...
            try
            {
                ...
                _logger.LogDebug("EXEC RSP_GL_GET_IMPORT_JOURNAL_ERROR_LIST {@Parameters} || GetImportAdjustmentJournalErrorList(Cls) ", loDbParam);

                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);

                loResult = R_Utility.R_ConvertTo<ImportAdjustmentJournalErrorDTO>(loDataTable).ToList();

                loResult = loResult.Select(i => new ImportAdjustmentJournalErrorDTO()
                {
                    INO = i.INO,
                    CNO = i.INO.ToString(),
        ...
        private async Task _BatchProcess(R_BatchProcessPar poBatchProcessPar)
        {
            ...
            ImportAdjustmentJournalSaveResultDTO loResult = new ImportAdjustmentJournalSaveResultDTO();
            ...
            try
            {
                ...
                var loTempObject = R_NetCoreUtility.R_DeserializeObjectFromByte<ImportAdjustmentJournalSaveParameterDTO>(poBatchProcessPar.BigObject);
        ...
        /*
                public void R_BatchProcess(R_BatchProcessPar poBatchProcessPar)
                {
                    ...
                    try
                    {
                        ...
                        lcQuery = $"CREATE TABLE #GLT00500_JOURNAL " +
                            $"(INO INT NOT NULL DEFAULT(0), " +
                            $"CPROCESS_ID VARCHAR(50) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CPROCESS_ID DEFAULT(''), " +
                            $"CCOMPANY_ID VARCHAR(8) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CCOMPANY_ID DEFAULT(''), " +
                            $"CDEPT_CODE VARCHAR(20) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CDEPT_CODE DEFAULT(''), " +
                            $"CTRANS_CODE VARCHAR(10) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CTRANS_CODE DEFAULT(''), " +
                            $"CREF_NO VARCHAR(30) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CREF_NO DEFAULT(''), " +
                            $"CREF_DATE CHAR(8) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CREF_DATE DEFAULT(''), " +
                            $"CDOC_NO VARCHAR(30) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CDOC_NO DEFAULT(''), " +
                            $"CDOC_DATE CHAR(8) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CDOC_DATE DEFAULT(''), " +
                            $"CTRANS_DESC NVARCHAR(200) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CTRANS_DESC DEFAULT(''), " +
                            $"CCURRENCY_CODE CHAR(3) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CCURRENCY_CODE DEFAULT(''), " +
                            $"NLBASE_RATE NUMERIC(20, 6) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_NLBASE_RATE DEFAULT(1), " +
                            $"NLCURRENCY_RATE NUMERIC(20, 6) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_NLCURRENCY_RATE DEFAULT(1), " +
                            $"NBBASE_RATE NUMERIC(20, 6) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_NBBASE_RATE DEFAULT(1), " +
                            $"NBCURRENCY_RATE NUMERIC(20, 6) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_NBCURRENCY_RATE DEFAULT(1), " +
                            $"CGLACCOUNT_NO VARCHAR(20) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CGLACCOUNT_NO DEFAULT(''), " +
                            $"CGLACCOUNT_NAME NVARCHAR(60) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CGLACCOUNT_NAME DEFAULT(''), " +
                            $"CCENTER_CODE VARCHAR(10) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CCENTER_CODE DEFAULT(''), " +
                            $"CDBCR CHAR(1) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CDBCR DEFAULT(''), " +
                            $"NTRANS_AMOUNT NUMERIC(19, 2) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_NTRANS_AMOUNT DEFAULT(0), " +
                            $"NLTRANS_AMOUNT NUMERIC(19, 2) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_NLTRANS_AMOUNT DEFAULT(0), " +
                            $"NBTRANS_AMOUNT NUMERIC(19, 2) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_NBTRANS_AMOUNT DEFAULT(0), " +
                            $"CDETAIL_DESC NVARCHAR(200) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CDETAIL_DESC DEFAULT(''), " +
                            $"CDOCUMENT_NO VARCHAR(20) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CDOCUMENT_NO DEFAULT(''), " +
                            $"CDOCUMENT_DATE CHAR(8) NOT NULL CONSTRAINT DF_GLT00500_JOURNAL_CDOCUMENT_DATE DEFAULT('')) ";

                        loDb.SqlExecNonQuery(lcQuery, loConn, false);

                        loDb.R_BulkInsert<BulkInsertParameterDTO>((SqlConnection)loConn, "#GLT00500_JOURNAL", loParam);
                        ...
                        *//*
                        ...
                        try
                        {
                            ...
                            loResult = R_Utility.R_ConvertTo<ImportAdjustmentJournalSaveResultDTO>(loDataTable).FirstOrDefault();
                        }
                        catch (Exception ex)
                        {
