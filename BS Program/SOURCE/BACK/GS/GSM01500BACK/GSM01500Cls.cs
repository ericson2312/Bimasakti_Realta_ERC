...
*/
            ...
            {
                loException.Add(ex);
                _loggerGSM01500Print.LogError(loException);
            }
        ...
        private void RSP_GS_MAINTAIN_CENTERMethod(CreateUpdateDeleteParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@CCOMPANY_ID", DbType.String, 50, poEntity.CCOMPANY_ID);
                loDb.R_AddCommandParameter(loCmd, "@CCENTER_CODE", DbType.String, 8, poEntity.Data.CCENTER_CODE);
                loDb.R_AddCommandParameter(loCmd, "@CCENTER_NAME", DbType.String, 80, poEntity.Data.CCENTER_NAME);
