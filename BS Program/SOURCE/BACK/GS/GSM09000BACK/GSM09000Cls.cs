    ...
    public class GSM09000Cls : R_BusinessObject<GSM09000ParameterDTO>
    {
        ...
        private void RSP_LM_MAINTAIN_TENANT_CTGMethod(GSM09000ParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@CTENANT_CATEGORY_ID", DbType.String, 20, poEntity.Data.CCATEGORY_ID);
                loDb.R_AddCommandParameter(loCmd, "@CTENANT_CATEGORY_NAME", DbType.String, 100, poEntity.Data.CCATEGORY_NAME);
                loDb.R_AddCommandParameter(loCmd, "@CNOTE", DbType.String, 255, poEntity.Data.CNOTE);
