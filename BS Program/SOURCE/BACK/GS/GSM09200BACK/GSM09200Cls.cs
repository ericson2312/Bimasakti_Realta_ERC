...
{
    public class GSM09200Cls : R_BusinessObject<GSM09200ParameterDTO>
    {
        ...
        public List<GSM09200DTO> GetExpenditureCategoryList(GetExpenditureCategoryListParameterDTO poEntity)
        {
            R_Exception loException = new R_Exception();
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
            ...
            try
            {
                ...
                _logger.LogDebug("EXEC RSP_GS_GET_CATEGORY_LIST {@Parameters} || GetExpenditureCategoryList(Cls) ", loDbParam);

                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);

                loResult = R_Utility.R_ConvertTo<GSM09200DTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override void R_Deleting(GSM09200ParameterDTO poEntity)
        {
            R_Exception loException = new R_Exception();
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
        ...
        protected override GSM09200ParameterDTO R_Display(GSM09200ParameterDTO poEntity)
        {
            R_Exception loException = new R_Exception();
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
            DbCommand loCmd = null;
            string lcQuery;
            GSM09200ParameterDTO loResult = new GSM09200ParameterDTO();
            ...
            try
            {
                ...
                loResult.Data = R_Utility.R_ConvertTo<GSM09200DetailDTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override void R_Saving(GSM09200ParameterDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            R_Exception loException = new R_Exception();
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@CCATEGORY_ID", DbType.String, 20, poNewEntity.Data.CCATEGORY_ID);
                loDb.R_AddCommandParameter(loCmd, "@CCATEGORY_NAME", DbType.String, 100, poNewEntity.Data.CCATEGORY_NAME);
                loDb.R_AddCommandParameter(loCmd, "@CNOTE", DbType.String, 255, poNewEntity.Data.CNOTE);
