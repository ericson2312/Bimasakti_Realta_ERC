    ...
    public class LMM03507Cls : R_BusinessObject<LMM03507ParameterDTO>
    {
        ...
        private void RSP_LM_MAINTAIN_TENANT_MEMBERMethod(LMM03507ParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@CMEMBER_NAME", DbType.String, 100, poEntity.Data.CMEMBER_NAME);
                ...
                loDb.R_AddCommandParameter(loCmd, "@CRELATIONSHIP", DbType.String, 30, poEntity.Data.CRELATIONSHIP);
                loDb.R_AddCommandParameter(loCmd, "@CID_TYPE", DbType.String, 50, poEntity.Data.CID_TYPE);
                loDb.R_AddCommandParameter(loCmd, "@CID_NO", DbType.String, 40, poEntity.Data.CID_NO);
                loDb.R_AddCommandParameter(loCmd, "@CNATIONALITY", DbType.String, 20, poEntity.Data.CNATIONALITY);
                loDb.R_AddCommandParameter(loCmd, "@CEMAIL", DbType.String, 100, poEntity.Data.CEMAIL);
                loDb.R_AddCommandParameter(loCmd, "@CMOBILE_PHONE1", DbType.String, 30, poEntity.Data.CMOBILE_PHONE1);
                loDb.R_AddCommandParameter(loCmd, "@CMOBILE_PHONE2", DbType.String, 30, poEntity.Data.CMOBILE_PHONE2);
