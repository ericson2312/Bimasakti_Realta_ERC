    ...
    public class LMM03504Cls : R_BusinessObject<LMM03504ParameterDTO>
    {
        ...
        protected override void R_Saving(LMM03504ParameterDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@CBILLING_TO", DbType.String, 100, poNewEntity.Data.CBILLING_TO);
                loDb.R_AddCommandParameter(loCmd, "@CBILLING_ADDRESS", DbType.String, 255, poNewEntity.Data.CBILLING_ADDRESS);
                loDb.R_AddCommandParameter(loCmd, "@CBILLING_EMAIL", DbType.String, 100, poNewEntity.Data.CBILLING_EMAIL);
                loDb.R_AddCommandParameter(loCmd, "@CBILLING_PHONE1", DbType.String, 30, poNewEntity.Data.CBILLING_PHONE1);
                loDb.R_AddCommandParameter(loCmd, "@CBILLING_PHONE2", DbType.String, 30, poNewEntity.Data.CBILLING_PHONE2);
                loDb.R_AddCommandParameter(loCmd, "@CBILLING_ATTENTION_NAME", DbType.String, 100, poNewEntity.Data.CBILLING_ATTENTION_NAME);
                loDb.R_AddCommandParameter(loCmd, "@CBILLING_ATTENTION_POSITION", DbType.String, 100, poNewEntity.Data.CBILLING_ATTENTION_POSITION);
