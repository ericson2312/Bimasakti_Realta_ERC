...
{
    public class LMM01010Cls : R_BusinessObject<LMM01010DTO>, R_IBatchProcess
    {
        ...
        private async Task _BatchProcess(R_BatchProcessPar poBatchProcessPar)
        {
            ...
            try
            {
                ...
                var loTempObject = R_NetCoreUtility.R_DeserializeObjectFromByte<LMM01010DTO>(poBatchProcessPar.BigObject);
                var loListTempTable = R_Utility.R_ConvertCollectionToCollection<LMM01011DTO, LMM01011SaveBatchDTO>(loTempObject.CRATE_EC_LIST);
                ...
                loDb.R_BulkInsert<LMM01011SaveBatchDTO>((SqlConnection)loConn, "#CRATE_EC_LIST", loListTempTable);

                lcQuery = "Select * From #CRATE_EC_LIST ";

                var loTesResult = loDb.SqlExecObjectQuery<LMM01011SaveBatchDTO>(lcQuery, loConn, false);
                ...
                loDb.R_AddCommandParameter(loCmd, "@NSTANDING_CHARGE", DbType.Int32, 50, loTempObject.NSTANDING_CHARGE);
                loDb.R_AddCommandParameter(loCmd, "@NBUY_STANDING_CHARGE", DbType.Int32, 50, loTempObject.NBUY_STANDING_CHARGE);
                loDb.R_AddCommandParameter(loCmd, "@NLWBP_CHARGE", DbType.Int32, 50, loTempObject.NLWBP_CHARGE);
                loDb.R_AddCommandParameter(loCmd, "@NBUY_LWBP_CHARGE", DbType.Int32, 50, loTempObject.NBUY_LWBP_CHARGE);
                loDb.R_AddCommandParameter(loCmd, "@NWBP_CHARGE", DbType.Int32, 50, loTempObject.NWBP_CHARGE);
                loDb.R_AddCommandParameter(loCmd, "@NBUY_WBP_CHARGE", DbType.Int32, 50, loTempObject.NBUY_WBP_CHARGE);
                loDb.R_AddCommandParameter(loCmd, "@NTRANSFORMATOR_FEE", DbType.Int32, 50, loTempObject.NTRANSFORMATOR_FEE);
                loDb.R_AddCommandParameter(loCmd, "@NBUY_TRANSFORMATOR_FEE", DbType.Int32, 50, loTempObject.NBUY_TRANSFORMATOR_FEE);
                loDb.R_AddCommandParameter(loCmd, "@LUSAGE_MIN_CHARGE", DbType.Boolean, 50, loTempObject.LUSAGE_MIN_CHARGE);
                loDb.R_AddCommandParameter(loCmd, "@NUSAGE_MIN_CHARGE", DbType.Int32, 50, loTempObject.NUSAGE_MIN_CHARGE);
                loDb.R_AddCommandParameter(loCmd, "@NKWH_USED_MAX", DbType.Int32, 50, loTempObject.NKWH_USED_MAX);
                loDb.R_AddCommandParameter(loCmd, "@NKWH_USED_RATE", DbType.Int32, 50, loTempObject.NKWH_USED_RATE);
                loDb.R_AddCommandParameter(loCmd, "@NBUY_KWH_USED_RATE", DbType.Int32, 50, loTempObject.NBUY_KWH_USED_RATE);
                loDb.R_AddCommandParameter(loCmd, "@NRETRIBUTION_PCT", DbType.Int32, 50, loTempObject.NRETRIBUTION_PCT);
                ...
                loDb.R_AddCommandParameter(loCmd, "@NADMIN_FEE_PCT", DbType.Int32, 50, loTempObject.NADMIN_FEE_PCT);
                loDb.R_AddCommandParameter(loCmd, "@NADMIN_FEE_AMT", DbType.Int32, 50, loTempObject.NADMIN_FEE_AMT);
                ...
                loDb.R_AddCommandParameter(loCmd, "@NKVA_RANGE", DbType.Int32, 50, loTempObject.NKVA_RANGE);
                loDb.R_AddCommandParameter(loCmd, "@NBUY_KVA_RANGE", DbType.Int32, 50, loTempObject.NBUY_KVA_RANGE);
