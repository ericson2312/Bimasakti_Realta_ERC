    ...
    public class LMM01000Cls : R_BusinessObject<LMM01000DTO>
    {
        ...
        public List<LMM01000PrintDTO> GetListDataPrint(LMM01000PrintParamDTO poEntity)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@LPRINT_DRAFT", DbType.Boolean, 50, poEntity.LPRINT_DRAFT);
                ...
                loResult = R_Utility.R_ConvertTo<LMM01000PrintDTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
