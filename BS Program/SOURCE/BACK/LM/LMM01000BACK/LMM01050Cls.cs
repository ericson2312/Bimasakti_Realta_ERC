    ...
    public class LMM01050Cls : R_BusinessObject<LMM01050DTO>, R_IBatchProcess
    {
        ...
        private async Task _BatchProcess(R_BatchProcessPar poBatchProcessPar)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@NUNIT_AREA_VALID_FROM", DbType.Int32, 50, loTempObject.NUNIT_AREA_VALID_FROM);
                loDb.R_AddCommandParameter(loCmd, "@NUNIT_AREA_VALID_TO", DbType.Int32, 50, loTempObject.NUNIT_AREA_VALID_TO);
