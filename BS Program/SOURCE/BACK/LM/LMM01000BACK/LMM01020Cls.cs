    ...
    public class LMM01020Cls : R_BusinessObject<LMM01020DTO>, R_IBatchProcess
    {
        ...
        private async Task _BatchProcess(R_BatchProcessPar poBatchProcessPar)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@NPIPE_SIZE", DbType.Int32, 50, loTempObject.NPIPE_SIZE);
                loDb.R_AddCommandParameter(loCmd, "@NSTANDING_CHARGE", DbType.Int32, 50, loTempObject.NSTANDING_CHARGE);
                loDb.R_AddCommandParameter(loCmd, "@NUSAGE_CHARGE_RATE", DbType.Int32, 50, loTempObject.NUSAGE_CHARGE_RATE);
                loDb.R_AddCommandParameter(loCmd, "@LUSAGE_MIN_CHARGE", DbType.Boolean, 50, loTempObject.LUSAGE_MIN_CHARGE);
                loDb.R_AddCommandParameter(loCmd, "@NUSAGE_MIN_CHARGE_AMT", DbType.Int32, 50, loTempObject.NUSAGE_MIN_CHARGE_AMT);
                loDb.R_AddCommandParameter(loCmd, "@NMAINTENANCE_FEE", DbType.Int32, 50, loTempObject.NMAINTENANCE_FEE);
                ...
                loDb.R_AddCommandParameter(loCmd, "@NBUY_USAGE_CHARGE_RATE", DbType.Int32, 50, loTempObject.NBUY_USAGE_CHARGE_RATE);
