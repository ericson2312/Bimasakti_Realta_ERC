    ...
    public class LMM04010Cls : R_BusinessObject<ProfileTaxParameterDTO>
    {
        ...
        private void RSP_LM_MAINTAIN_TENANTMethod(ProfileTaxParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@CLOGIN_COMPANY_ID", DbType.String, 50, poEntity.CLOGIN_COMPANY_ID);
                loDb.R_AddCommandParameter(loCmd, "@CSELECTED_PROPERTY_ID", DbType.String, 50, poEntity.CSELECTED_PROPERTY_ID);
                loDb.R_AddCommandParameter(loCmd, "@CTENANT_ID", DbType.String, 20, poEntity.Profile.CTENANT_ID);
                loDb.R_AddCommandParameter(loCmd, "@CTENANT_NAME", DbType.String, 100, poEntity.Profile.CTENANT_NAME);
                loDb.R_AddCommandParameter(loCmd, "@CADDRESS", DbType.String, 255, poEntity.Profile.CADDRESS);
                loDb.R_AddCommandParameter(loCmd, "@CCITY_CODE", DbType.String, 20, poEntity.Profile.CCITY_CODE);
                loDb.R_AddCommandParameter(loCmd, "@CSTATE_CODE", DbType.String, 20, poEntity.Profile.CSTATE_CODE);
                loDb.R_AddCommandParameter(loCmd, "@CCOUNTRY_CODE", DbType.String, 20, poEntity.Profile.CCOUNTRY_CODE);
                loDb.R_AddCommandParameter(loCmd, "@CPOSTAL_CODE", DbType.String, 20, poEntity.Profile.CPOSTAL_CODE);
                loDb.R_AddCommandParameter(loCmd, "@CEMAIL", DbType.String, 100, poEntity.Profile.CEMAIL);
                loDb.R_AddCommandParameter(loCmd, "@CPHONE1", DbType.String, 30, poEntity.Profile.CPHONE1);
                loDb.R_AddCommandParameter(loCmd, "@CPHONE2", DbType.String, 30, poEntity.Profile.CPHONE2);
                ...
                loDb.R_AddCommandParameter(loCmd, "@CATTENTION1_NAME", DbType.String, 100, poEntity.Profile.CATTENTION1_NAME);
                loDb.R_AddCommandParameter(loCmd, "@CATTENTION1_POSITION", DbType.String, 100, poEntity.Profile.CATTENTION1_POSITION);
                loDb.R_AddCommandParameter(loCmd, "@CATTENTION1_EMAIL", DbType.String, 100, poEntity.Profile.CATTENTION1_EMAIL);
                loDb.R_AddCommandParameter(loCmd, "@CATTENTION1_MOBILE_PHONE1", DbType.String, 30, poEntity.Profile.CATTENTION1_MOBILE_PHONE1);
                loDb.R_AddCommandParameter(loCmd, "@CATTENTION1_MOBILE_PHONE2", DbType.String, 30, poEntity.Profile.CATTENTION1_MOBILE_PHONE2);
                loDb.R_AddCommandParameter(loCmd, "@CATTENTION2_NAME", DbType.String, 100, poEntity.Profile.CATTENTION2_NAME);
                loDb.R_AddCommandParameter(loCmd, "@CATTENTION2_POSITION", DbType.String, 100, poEntity.Profile.CATTENTION2_POSITION);
                loDb.R_AddCommandParameter(loCmd, "@CATTENTION2_EMAIL", DbType.String, 100, poEntity.Profile.CATTENTION2_EMAIL);
                loDb.R_AddCommandParameter(loCmd, "@CATTENTION2_MOBILE_PHONE1", DbType.String, 30, poEntity.Profile.CATTENTION2_MOBILE_PHONE1);
                loDb.R_AddCommandParameter(loCmd, "@CATTENTION2_MOBILE_PHONE2", DbType.String, 30, poEntity.Profile.CATTENTION2_MOBILE_PHONE2);
                ...
                loDb.R_AddCommandParameter(loCmd, "@CFAMILY_CARD", DbType.String, 40, "");
                ...
                loDb.R_AddCommandParameter(loCmd, "@CTAX_ID", DbType.String, 40, poEntity.TaxInfo.CTAX_ID);
                loDb.R_AddCommandParameter(loCmd, "@CTAX_NAME", DbType.String, 100, poEntity.TaxInfo.CTAX_NAME);
                loDb.R_AddCommandParameter(loCmd, "@CID_TYPE", DbType.String, 50, poEntity.TaxInfo.CID_TYPE);
                loDb.R_AddCommandParameter(loCmd, "@CID_NO", DbType.String, 40, poEntity.TaxInfo.CID_NO);
                ...
                loDb.R_AddCommandParameter(loCmd, "@CTAX_ADDRESS", DbType.String, 255, poEntity.TaxInfo.CTAX_ADDRESS);
                loDb.R_AddCommandParameter(loCmd, "@CTAX_PHONE1", DbType.String, 30, poEntity.TaxInfo.CTAX_PHONE1);
                loDb.R_AddCommandParameter(loCmd, "@CTAX_PHONE2", DbType.String, 30, poEntity.TaxInfo.CTAX_PHONE2);
                loDb.R_AddCommandParameter(loCmd, "@CTAX_EMAIL", DbType.String, 100, poEntity.TaxInfo.CTAX_EMAIL);
        ...
        protected override ProfileTaxParameterDTO R_Display(ProfileTaxParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                var loTemp1 = R_Utility.R_ConvertTo<LMM04010DTO>(loDataTable).FirstOrDefault();
                var loTemp2 = R_Utility.R_ConvertTo<LMM04020DTO>(loDataTable).FirstOrDefault();
